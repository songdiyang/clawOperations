...
- 新增预览模态框系统，支持图片和视频的集成预览
- 改进加载状态管理，优化后台轮询机制
- 增强URL处理能力，解决豆包URL过期问题
...
**更新** 新版本引入了TaskList页面的AI任务集成，实现了发布任务和AI任务的统一管理，提供实时进度监控和智能重试功能。TaskList页面现在支持AI创作任务与传统定时发布任务的合并展示，包含实时进度条、状态筛选、类型过滤等新功能。新增的预览模态框系统提供了更好的内容预览体验，从外部链接预览转变为集成的模态框预览。
...
AICreator --> GeneratedContent : "生成"
AICreator --> GeneratedCopywriting : "生成"
TaskList --> UnifiedTask : "合并"
TaskList --> AITask : "管理"
TaskList --> PreviewModal : "使用"
UnifiedTask --> GeneratedContent : "包含"
UnifiedTask --> GeneratedCopywriting : "可能包含"
```
...
**更新** 新的UI改进和功能增强进一步提升了用户的创作体验，使AI创作变得更加简单、高效和直观。预览模态框系统、增强的URL处理能力和改进的加载状态管理为用户提供了更稳定和流畅的使用体验。从外部链接预览转变为集成的模态框预览，不仅提升了用户体验，还解决了URL过期等技术问题。
...
新增的预览模态框系统是本次更新的重要亮点，它提供了更好的内容预览体验，支持图片和视频的集成预览，解决了外部链接预览的局限性。智能的URL处理能力确保了即使在URL过期的情况下也能正常预览内容，提升了系统的稳定性和用户体验。这些改进使得AI创作页面更加完善，为用户提供了更加强大和易用的内容创作工具。