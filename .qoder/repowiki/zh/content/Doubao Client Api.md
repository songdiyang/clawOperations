...
**图表来源**
- [doubao-client.ts:1-379](file://src/api/ai/doubao-client.ts#L1-L379)
...
**章节来源**
- [doubao-client.ts:85-379](file://src/api/ai/doubao-client.ts#L85-L379)
- [content-generator.ts:38-253](file://src/services/ai/content-generator.ts#L38-L253)
...
**图表来源**
- [doubao-client.ts:192-274](file://src/api/ai/doubao-client.ts#L192-L274)
...
该系统为开发者提供了一个可靠的AI内容生成基础框架，可以根据具体需求进行定制和扩展。新增的参考图像支持功能进一步增强了系统的实用性和灵活性，使其能够更好地满足现代内容营销的需求。